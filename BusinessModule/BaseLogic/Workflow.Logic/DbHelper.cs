...
namespace Workflow.Logic
{
    ...
    {
        public static DataTable GetFieldTable(string connName, string tableName)
        {
...
", tableName);
        ...
        private static bool CompareDicItem(Dictionary<string, string> dic1, Dictionary<string, string> dic2, string key, EnumerableRowCollection<DataRow> dt = null)
        {
