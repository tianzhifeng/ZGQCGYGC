...
namespace DocSystem.Logic.Domain
{
    public static class BaseModelExtend
    {
        ...
        /// <returns></returns>
        public static SQLHelper GetDocConfigSqlHelper(this BaseModel model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static DocConfigEntities GetDocConfigContext(this BaseModel model) 
        {
            return FormulaHelper.GetEntities<DocConfigEntities>();
        } 
