...
";
            ...
            DataTable tbRooms = OfficeAutoDb.ExecuteDataTable("select Id,ROOMNAME,LinkName from S_M_ConferenceRoom");
            ...
            foreach (DataRow dr in tbRooms.Rows)
            {
                ...
                responeHtml += String.Format(ConferenceFO.MeetingBody, dr[1], s1Up, s1Down, s2Up, s2Down, s3Up, s3Down, s4Up, s4Down, s5Up, s5Down, s6Up, s6Down, s7Up, s7Down, roomNum);
            }
