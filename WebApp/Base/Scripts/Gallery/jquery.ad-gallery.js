    ...
    AdGallery.prototype = {
        ...
        _afterShow: function () {
            ...
            if (!this.settings.cycle) {
                // Needed for IE
                this.prev_link.show().css('height', $(".ad-image-wrapper").height());
                this.next_link.show().css('height', $(".ad-image-wrapper").height());
        ...
        _getContainedImageSize: function (image_width, image_height) {
            ...
            if (image_height > $(".ad-image-wrapper").height()) {
        ...
        _centerImage: function (img_container, image_width, image_height) {
            ...
            if (image_height < $(".ad-image-wrapper").height()) {
                var dif = $(".ad-image-wrapper").height() - image_height;
                img_container.css('top', (dif / 2) + 'px');
            };
            img_container.css('left', '0px');
            if (image_width < $(".ad-image-wrapper").width()) {
                var dif = $(".ad-image-wrapper").width() - image_width;
