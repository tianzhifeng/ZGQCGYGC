...
handwritedlg:'<div class="kg-dialog kg-dialog-info" id="kg-handwrite" unselectable="on" onselectstart="return false;" style="-moz-user-select:none;">name:<input type="text" value="\u624b\u5199\u7b7e\u540d" id="nameid" />color:<select id="hw_color"><option value="black">black</option><option value="red">red</option><option value="blue">blue</option><option value="green">green</option></select>width:<select id="hw_width"><option value="1">1</option><option value="2" selected>2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select><canvas id="canvasId" width=670px height=500px></canvas><br /><div id="div-judge" style="display: block"><button type="button" id="clearid" class="kg-button">\u6e05\u9664</button><button type="button" id="okid" class="kg-button">\u7b7e\u540d</button></div></div>',
