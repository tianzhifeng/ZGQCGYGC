...
{
    public class ComprehensiveController : MvcAdapter.BaseController
    {
        ...
        protected override DbContext entities
        {
            get
            {
                if (_entities == null)
                {
                    _entities = FormulaHelper.GetEntities<ComprehensiveEntities>();
                }
                return _entities;
            }
        }
    ...
    public class ComprehensiveController<T> : MvcAdapter.BaseController<T> where T : class, new()
    {
        private DbContext _entities = null;
