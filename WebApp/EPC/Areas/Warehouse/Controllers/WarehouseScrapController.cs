...
{
    public class WarehouseScrapController : EPCFormContorllor<T_W_WarehouseScrap>
    {
        ...
        protected override void BeforeSaveDetail(Dictionary<string, string> dic, string subTableName, Dictionary<string, string> detail, List<Dictionary<string, string>> detailList, Base.Logic.Domain.S_UI_Form formInfo)
        {
            ...
            if (count <= 0)
                throw new Formula.Exceptions.BusinessException("报废数量必须大于零，请重新输入");
            ...
            if ((accountCount -
                ...
                throw new Formula.Exceptions.BusinessException("报废数量大于可报废数量，请重新输入");
        }
