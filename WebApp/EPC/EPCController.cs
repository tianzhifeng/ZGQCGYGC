...
namespace EPC
{
    public class EPCController : MvcAdapter.BaseController
    {
        ...
        protected override DbContext entities
        {
            get
            {
                if (_entities == null)
                {
                    _entities = FormulaHelper.GetEntities<EPCEntities>();
                }
                return _entities;
            }
        }
        ...
        protected virtual SQLHelper SqlHelper
        {
            get
            {
                if (_sqlHelper == null)
                {
                    _sqlHelper = SQLHelper.CreateSqlHelper(ConnEnum.Engineering);
                }
                return _sqlHelper;
            }
        }
    ...
    public class EPCController<T> : MvcAdapter.BaseController<T> where T : class, new()
    {
        private DbContext _entities = null;
