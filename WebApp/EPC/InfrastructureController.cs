...
namespace EPC
{
    public class InfrastructureController : MvcAdapter.BaseController
    {
        ...
        protected override DbContext entities
        {
            get
            {
                if (_entities == null)
                {
                    _entities = FormulaHelper.GetEntities<InfrastructureEntities>();
                }
                return _entities;
            }
        }
        ...
        protected virtual SQLHelper SqlHelper
        {
            get
            {
                if (_sqlHelper == null)
                {
                    _sqlHelper = SQLHelper.CreateSqlHelper(ConnEnum.Infrastructure);
                }
                return _sqlHelper;
            }
        }
    ...
    public class InfrastructureController<T> : MvcAdapter.BaseController<T> where T : class, new()
    {
        private DbContext _entities = null;
