...
<div style='width: 100%; position: fixed; top: 0; left: 0; z-index: 999;' id='flowBar'>
    <ul id='flowMenubar' class='mini-menubar' style='width: 100%;'>
        <div property='toolbar'>
            <span id='divFormVersion' style='display:none;'>版本号：<div id='cmbVersion' class='mini-combobox' style='width:50px;' onvaluechanged='onVersionChanged'></div> </span>
            <span id='divFormStatus' style='display:none'>&nbsp;表单状态：<span id='spanFormStatus'>未启动</span></span>&nbsp;
<span name="urgency" class="mini-checkbox"  text="是否紧急"></span>&nbsp;&nbsp;
...
<div id="adviceWindow" class="mini-window" title="意见" style="width: 420px; min-height: 130px; position: fixed; z-index: 999;" showmodal="true" allowresize="false" allowdrag="true">
    <div class="queryDiv">
...
<div id="commentWindow" class="mini-window" title="回复消息" style="width: 420px; min-height: 130px; position: fixed; z-index: 999;" showmodal="true" allowresize="false" allowdrag="true">
    <input id="nodeID" style="display: none;" />
    <div>
        <form id="commentForm" method="post">
            <div><input name='_Comment' emptytext='请输入消息' class='mini-textarea' style='width: 100%; height: 67px;' /></div>
            <div style="height: 25px; text-align: left; border-bottom: solid 1px #cccccc;padding-top:8px;padding-bottom:8px;">
                <div style="text-overflow:ellipsis;overflow:hidden;white-space:nowrap; height: 28px; padding-left:5px; line-height: 28px; width: 200px; float: left;" >
                    ...
                    <div class="flow-addCss"><a id="commentUser" ids="" style="color: #3c8dbc;cursor: pointer;" onclick="addCommentUser()">抄送人员</a></div>
                </div>
        ...
        <div id="_flowCommentButton" style="text-align:center;padding:10px;">
            <a id="submitComment" class='mini-button mini-button-plain' onclick="saveComment()" style='margin-right: 20px;' hidefocus=''><span class='mini-button-text  mini-button-icon icon-ok'>确定</span></a>
            <a id="clearComment" class='mini-button mini-button-plain' hidefocus='' onclick='clearComment()'><span class='mini-button-text  mini-button-icon icon-undo'>清空</span></a>
            <a id="clearUserComment" style="display: none;" class='mini-button mini-button-plain' hidefocus='' onclick="clearComment('user')"><span class='mini-button-text  mini-button-icon icon-undo'>清空人员</span></a>
            <a id="clearFileComment" style="display: none;" class='mini-button mini-button-plain' hidefocus='' onclick="clearComment('file')"><span class='mini-button-text  mini-button-icon icon-undo'>清空附件</span></a>
        </div>
    </div>
</div>
    ...
    function flowApprove(button, bType) {
        if (FlowCurrntStep && FlowCurrntStep.HideAdvice == "1"){
            ...
            var html = "<a class='mini-button mini-button-plain' style='margin-right: 20px;' hidefocus='' "+click+" href='javascript:void(0)'><span class='mini-button-text  mini-button-icon icon-ok'>"
                + "确定</span></a> <a class='mini-button mini-button-plain' hidefocus='' onclick='clearAdvice()' href='javascript:void(0)'><span class='mini-button-text  mini-button-icon icon-undo'>清空</span></a>";
